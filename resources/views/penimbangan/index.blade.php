...
<table class="table table-bordered mt-5">
  ...
  <!-- <a href="/penimbangan/create" class="btn btn-primary">Tambah Data Penimbangan</a> -->
  ...
  <tr>
    ...
    <!-- <td>
      <a href="/penimbangan/{{$penimbangan->id}}/edit" class="btn btn-warning">Edit</a>
      <form class="d-inline" action="/penimbangan/{{$penimbangan->id}}" method="post">
        @method('DELETE')
        @csrf
